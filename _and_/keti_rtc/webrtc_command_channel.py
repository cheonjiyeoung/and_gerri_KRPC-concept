...
class WebRtcCommandChannel:
    def __init__(self, robot_id, password, server_host, server_port, api_key, robot_group_id=None, camera=DummyCamera(), loop: AbstractEventLoop = None, message_duration_time=100):
        self.loop = loop
