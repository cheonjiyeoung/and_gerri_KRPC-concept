...
class ZeroMQRobot:
    def __init__(self, target_ip='localhost', pub_port=8200, sub_port=8100):
        """
        ZeroMQ 기반 PUB-SUB 통신 매니저 (로봇쪽)
    ...
    def receive_messages(self):
        ...
        while True:
            ...
            pub.sendMessage("receive_message", message=message)  # 내부 이벤트로 데이터 전달
