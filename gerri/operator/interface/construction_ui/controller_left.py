...
class RobotControllerLeft(QWidget):
    def __init__(self, widget_w, widget_h):
        ...
        self.target_x.setRange(-900.0, 900.0)
        self.target_x.setValue(35.4)
        ...
        self.target_y.setRange(-900.0, 900.0)
        self.target_y.setValue(-144.7)
        ...
        self.target_z.setRange(-900.0, 900.0)
        self.target_z.setValue(582.9)
        ...
        self.target_rx.setRange(-360.0, 360.0)
        self.target_rx.setValue(90.0)
        ...
        self.target_ry.setRange(-360.0, 360.0)
        self.target_ry.setValue(-70.0)
        ...
        self.target_rz.setRange(-360.0, 360.0)
        ...
        self.Reload_1 = QPushButton("Reload_1")
        self.Reload_2 = QPushButton("Reload_2")
        self.Reload_3 = QPushButton("Reload_3")

        ##### Left WebRTC Connection Box#####
        state_label = QLabel("State")
        state_label.adjustSize()
        self.robot_state_edit.setFixedWidth(90)


        ##### Left Joint Current Box##### 
        ...
        pose_target_box = QGroupBox("Left MoveL")
        ...
        other_command_layout = QGridLayout(self)
        other_command_layout.addWidget(self.Reload_1)
        other_command_layout.addWidget(self.Reload_2)
        other_command_layout.addWidget(self.Reload_3)
...
if __name__ == "__main__":
    ...
    window = RobotControllerLeft(925, 408)
