...
from gerri.operator.function.manipulator_function import ManipulatorCommander
from gerri.operator.function.mobile_function import MobileCommander
...
class SampleBaseCommander(MobileCommander, ManipulatorCommander):
