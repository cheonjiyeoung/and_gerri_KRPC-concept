...
class DoosanMRightCommander:
    def __init__(self):
        self.joint_names = ["right_joint_1", "right_joint_2", "right_joint_3", "right_joint_4", "right_joint_5", "right_joint_6"]
    ...
    def stop(self):
        pub.sendMessage('right_stop_robot', pause_type='SSTOP')
    ...
    def moveJ(self, j1, j2, j3, j4, j5, j6, vel, acc):
        ...
        pub.sendMessage('right_movej_message', joint_angle=self.target_posj, joint_velocity=self.target_velj, joint_acceleration=self.target_accj)
    ...
    def moveL(self, x, y, z, rx, ry, rz, vel, acc):
        ...
        pub.sendMessage('right_movel_message', point=self.target_point, angle=self.target_angle, velocity=self.target_vell, acceleration=self.target_accl)
    ...
    def master_read_start(self):
        ...
        if not self.master_start:
            ...
            pub.sendMessage('right_set_master_joint', master_start=self.master_start)
            ...
            if self.master_start:
                ...
                if gripper_moving <= -45.:
                    ...
                    if self.gripper_active == True:
                        ...
                        pub.sendMessage('right_joint_ctrl_master', joint_ctrl_master=joint_ctrl_master, joint_velocity=150, joint_acceleration=150, round=200)
            time.sleep(0.3)
    ...
    def move_gripper(self):
        pub.sendMessage('right_moving_gripper', moving_offset=5.)

    def master_go_back(self):
        self.going_back = True
        pub.sendMessage('right_movej_message', joint_angle=self.go_back_joint, joint_velocity=20, joint_acceleration=20)
