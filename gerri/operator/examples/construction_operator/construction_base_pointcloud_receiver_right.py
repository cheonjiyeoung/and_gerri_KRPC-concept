...
class ConstructionBasePointcloudReceiver(Node):
    def __init__(self, robot_info, **params):
        super().__init__('publish_pointcloud_right')
        ...
        self.pointcloud_pub = self.create_publisher(PointCloud2, '/cloud_in_right', 1)
    ...
    def pub_point_cloud(self):
        while True:
            ...
            if not self.receive_message_pointcloud:
                ...
                self.pub_message.header.frame_id = 'right_camera_depth_optical_frame'
