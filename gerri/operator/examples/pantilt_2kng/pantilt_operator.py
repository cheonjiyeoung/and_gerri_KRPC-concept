...
class PantiltOperator:
    def __init__(self):
        ...
        pub.subscribe(self.vr_pose_control, 'vr_pose')
    ...
    def key_mouse_control(self, command):
        ...
        if "ALT" in key:
            pan_tilt_command = pantilt_command.pan_tilt_step(pan_tilt_angle_step=mouse_d_move)
    ...
    def vr_pose_control(self, position, orientation):
        ...
        # round(math.degrees(orientation.z))
