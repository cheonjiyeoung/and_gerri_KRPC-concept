...
class GydMobileController:
    ...
    def move_waypoint_async(self,poi):
        loop = asyncio.get_event_loop()
        loop.create_task(self._move_waypoint_async(poi))

    async def _move_waypoint_async(self,poi):
    ...
    def send_message(self,message:dict):
        pub.sendMessage("solar",value = message)
