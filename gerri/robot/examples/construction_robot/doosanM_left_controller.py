    ...
    def connect(self, ip, port):
        ...
        while True:
            try:
                ...
                if connection:
                    print("############ Connect to Doosan M1509 Left ###############")
                    return self.client
                else:
                    print(f"Doosan Left로봇에 연결 실패. {self.retry_delay}초 후 다시 시도합니다.")
            except Exception as e:
                print(f"Left 연결 중 오류 발생: {e}. {self.retry_delay}초 후 다시 시도합니다.")
