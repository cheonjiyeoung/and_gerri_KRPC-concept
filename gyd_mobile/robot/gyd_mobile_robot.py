...
from robot.gyd_mobile_config import ROBOT_INFO, VIDEO_INFO, AUDIO_INFO
...
from gyd_mobile_sub_controller import GydMobileSubController
...
sub_controllers = {"gyd_mobile_01": GydMobileSubController(ROBOT_INFO['id'], ROBOT_INFO['model'], ROBOT_INFO['category'])}
