...
from hello_universe_config import ROBOT_INFO, OPERATOR_INFO, VIDEO_INFO, VIDEO_CHANNEL, AUDIO_CHANNEL
...
front_cam_receiver = OperatorMediaReceiever(robot_info=ROBOT_INFO, operator_info=OPERATOR_INFO, channel_info=VIDEO_CHANNEL)
front_cam_receiver.connect()

# audio_receiver = OperatorMediaReceiever(robot_info=ROBOT_INFO, operator_info=OPERATOR_INFO, channel_info=AUDIO_CHANNEL)
# audio_receiver.connect()
